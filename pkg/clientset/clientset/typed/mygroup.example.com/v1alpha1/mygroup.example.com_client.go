...
import (
	...
	"github.com/gwuud/my-first-crd/pkg/clientset/clientset/scheme"
...
type MygroupV1alpha1Interface interface {
	...
	MyResourcesGetter
	MyResourceListsGetter
	MyResourceSpecsGetter
}
...
func (c *MygroupV1alpha1Client) MyResourceLists(namespace string) MyResourceListInterface {
	return newMyResourceLists(c, namespace)
}

func (c *MygroupV1alpha1Client) MyResourceSpecs(namespace string) MyResourceSpecInterface {
	return newMyResourceSpecs(c, namespace)
}
